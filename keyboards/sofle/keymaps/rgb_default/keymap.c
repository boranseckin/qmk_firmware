 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | ALT  |      | GUI  | LOWER| /Space  /       \Enter \  |SPACE |UPPER |      |      |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
  [_QWERTY] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|  ===  |     |  ===  |--------+-------+--------+--------+--------+---------|
                 KC_LALT, KC_NO,   TL_LOWR, KC_LGUI,  KC_SPC,    HYPR(KC_GRV),TL_UPPR, KC_NO, KC_NO,   KC_NO
  //            \--------+--------+--------+---------+-------|     |-------+---------+--------+--------+-------/
),
...
[_LOWER] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+--------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  _______,  KC_NO,  KC_LABK, KC_RABK, KC_LCBR, KC_RCBR, _______,    _______,KC_LBRC, KC_RBRC, KC_MINS, KC_EQL,  KC_NO,  _______,
  //|------+-------+--------+--------+--------+--------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
 ...
 * | trans|      |      |      |      |      |                    | WH_U |      |  Up  |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | trans|      |      | Del  | Bspc |      |-------.    ,-------| WH_D | Left | Down | Rigth|      |      |
 * |------+------+------+------+------+------| trans |    | trans |------+------+------+------+------+------|
...
[_UPPER] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______,  KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_WH_U, KC_NO,  KC_UP,   KC_NO,   KC_NO,   KC_NO,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______,  KC_NO,  KC_NO,   KC_DEL,  KC_BSPC, KC_NO,                     KC_WH_D, KC_LEFT,KC_DOWN, KC_RIGHT,KC_NO,   KC_NO,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
...
[_ADJUST] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______,  AG_TOGG,KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_NO,   KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
