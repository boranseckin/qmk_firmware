 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | ALT  |LOWER | GUI  | LOWER| /Space  /       \Enter \  |SPACE |RAISE | RCTR | RAlt |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
  [_QWERTY] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  KC_LALT, KC_LOWER, KC_LGUI, KC_LOWER, KC_SPC,     KC_ENT,KC_RAISE, KC_NO, KC_RCTL, KC_RALT
  //            \--------+--------+--------+---------+-------|   |-------+---------+--------+---------+-------/
  ),
 ...
 * | trans|      |   <  |   >  |   {  |   }  |-------|    |-------|   [  |   ]  |   -  |   =  |      | trans|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | Bspc |LOWER | CMD  | Enter| /Space  /       \Enter \  |SPACE |RAISE | RCTR | RAlt |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_LOWER] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+--------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  _______,  KC_NO,  KC_NO,   KC_NO,   KC_LCBR, KC_RCBR, _______,    _______,KC_LBRC, KC_RBRC, KC_MINS, KC_EQL,  KC_NO  , _______,
  //|------+-------+--------+--------+--------+--------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
...
[_RAISE] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______, KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX, KC_CAPS,                KC_MINS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PIPE, KC_GRV,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
